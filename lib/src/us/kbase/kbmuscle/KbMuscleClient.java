...
public class KbMuscleClient {
     ...
     * credentials.
     */
    public KbMuscleClient(URL url, String user, String password, URL auth) throws UnauthorizedException, IOException {
    ...
    public MUSCLEOutput mUSCLENuc(MUSCLEParams params, RpcContext... jsonRpcContext) throws IOException, JsonClientException {
        ...
        List<MUSCLEOutput> res = caller.jsonrpcCall("kb_muscle.MUSCLE_nuc", args, retType, true, true, jsonRpcContext, this.serviceVersion);
        return res.get(0);
    }
    ...
    public MUSCLEOutput mUSCLEProt(MUSCLEParams params, RpcContext... jsonRpcContext) throws IOException, JsonClientException {
        ...
        args.add(params);
        TypeReference<List<MUSCLEOutput>> retType = new TypeReference<List<MUSCLEOutput>>() {};
        List<MUSCLEOutput> res = caller.jsonrpcCall("kb_muscle.MUSCLE_prot", args, retType, true, true, jsonRpcContext, this.serviceVersion);
        return res.get(0);
    }
    ...
    public Map<String, Object> status(RpcContext... jsonRpcContext) throws IOException, JsonClientException {
        ...
        List<Map<String, Object>> res = caller.jsonrpcCall("kb_muscle.status", args, retType, true, false, jsonRpcContext, this.serviceVersion);
        return res.get(0);
    }
}
